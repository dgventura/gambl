...
// Game_Music_Box 0.5.2. Copyright (C) 2003-2005 Shay Green. GNU LGPL license.
...
public:
	...
	void set_end_time( nes_time_t t )   { end_time_ = t - base_time; update_clock_limit(); }
	void set_irq_time( nes_time_t t )   { irq_time_ = t - base_time; update_clock_limit(); }
